...
@Component({
  selector: 'CustomerAddress-home',
  templateUrl: './CustomerAddress-home.component.html',
  styleUrls: ['./CustomerAddress-home.component.scss']
})
export class CustomerAddressHomeComponent implements AfterViewInit {
