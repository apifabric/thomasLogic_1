...
@Component({
  selector: 'PaymentMethod-home',
  templateUrl: './PaymentMethod-home.component.html',
  styleUrls: ['./PaymentMethod-home.component.scss']
})
export class PaymentMethodHomeComponent implements AfterViewInit {
