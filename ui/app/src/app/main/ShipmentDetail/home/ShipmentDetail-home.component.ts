...
@Component({
  selector: 'ShipmentDetail-home',
  templateUrl: './ShipmentDetail-home.component.html',
  styleUrls: ['./ShipmentDetail-home.component.scss']
})
export class ShipmentDetailHomeComponent implements AfterViewInit {
