...
resourcename="thomaslogic1"  # lower case, only
resourcegroup="thomaslogic1_rg"
...
# git clone https://github.com/apilogicserver/thomaslogic1.git
# cd thomaslogic1
...
az group create --name thomaslogic1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group thomaslogic1_rg --sku S1 --is-linux
az container create --resource-group thomaslogic1_rg --name thomaslogic1 --image apilogicserver/thomaslogic1:latest --dns-name-label thomaslogic1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//thomaslogic1.westus.azurecontainer.io:5656'
